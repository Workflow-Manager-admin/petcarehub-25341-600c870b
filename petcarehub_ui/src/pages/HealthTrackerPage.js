 ...
 * Visual ROUTE confirmation: Large accent banner & message for router visibility testing [LIVE TEST]
 */
function HealthTrackerPage() {
  ...
  return (
    <div style={{ margin: 0, padding: 0 }}>
      {/* ACCENT BANNER: ROUTE TEST CONFIRMATION */}
      <div
        style={{
          width: '100%',
          background: 'linear-gradient(90deg,#E87A41 30%,#FFD700 100%)',
          color: 'white',
          padding: '2.2rem 0 1.5rem 0',
          textAlign: 'center',
          marginBottom: 26,
          boxShadow: '0 4px 24px 0 rgba(232,122,65,0.15)',
          zIndex: 50
        }}
        data-testid="health-tracker-live-banner"
      >
        <h1 style={{
          fontSize: '2.7rem',
          margin: 0,
          ...
          textShadow: '1px 2px 16px #874e15, 0px 1px 0px #FFD700'
        }}>
          Health Tracker <span style={{
            fontSize: '1.3rem',
            background: '#1A1A1A',
            color: '#FFD700',
            padding: '3px 14px',
      ...
      {/* TEMPORARY MESSAGE BOX FOR ROUTING TEST */}
      <div
        style={{
          width: "96vw",
          maxWidth: 860,
          ...
          letterSpacing: 0.5,
          textAlign: "center",
          boxShadow: "0 2px 12px 0 rgba(232,122,65,0.08)"
        }}
        role="status"
      >
        ✅ This is the <b>Health Tracker</b> page! If you see this heading and banner, route and file mapping are working.
      </div>
      {/* Original Health Tracker Page UI */}
